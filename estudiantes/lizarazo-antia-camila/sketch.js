...
function dibujarFormulario() {
  ...
  strokeWeight(2);
  fill("#F9ED32");
  ellipse(243, 160, 13, 13);
  noFill();
  line(243, 146, 243, 174);
  line(232, 150, 253, 170);
  line(228, 160, 257, 160);
  line(232, 170, 253, 150);

  //nublado
  stroke("#F9ED32");
  strokeWeight(2);
  fill("#F9ED32");
  ellipse(234, 193, 11.5, 11.5);
  noFill();
  line(234, 183, 234, 203);
  line(226, 186, 241, 200);
  line(223, 193, 244, 193);
  line(226.3, 200, 241.5, 185);
  noStroke();
  fill("rgb(5,98,119)");
  ellipse(239, 197, 14, 11);
  ellipse(246, 192, 14, 11);
  ellipse(244, 199, 14, 11);
  ellipse(253, 193, 14, 11);
  ellipse(252, 196, 14, 11);

  //lluvioso: nube con líneas diagonales para sugerir lluvia
  noStroke();
  fill("rgb(5,98,119)");
  ellipse(237, 228, 18, 14);
  ellipse(244, 223, 18, 14);
  ellipse(242, 230, 18, 14);
  ellipse(251, 224, 18, 14);
  ellipse(250, 227, 18, 14);
  stroke(255);
  strokeWeight(1);
  line(232, 216, 229, 221);
  line(239, 218, 236, 223);
  line(246, 215, 243, 220);
  line(253, 217, 250, 222);
  line(228, 229, 225, 234);
  line(236, 226, 233, 231);
  line(243, 231, 240, 236);
  line(250, 228, 247, 233);
  line(257, 232, 254, 237);
...
function dibujarResultado() {
  ...
  if (climaGuardado === "nublado" || climaGuardado === "lluvioso") {
    ...
    ellipse(60, 40, 50, 30);
    ellipse(80, 30, 50, 30);
    ellipse(100, 40, 50, 30);
    ellipse(300, 35, 55, 30);
    ellipse(325, 25, 55, 30);
    ellipse(350, 35, 55, 30);
  }
